...
```{r regression_prep, message=FALSE, warning=FALSE}
# ---Prep-Regression---
library(lubridate)
...
# Convert necessary predictors to numeric
...
# Regression predicting number of collisions
model_trend <- lm(
...
# Extract year and month for prediction
